...
public class CodeGenerator {
    ...
    public static void main(String[] args) throws TemplateException, IOException {
        ...
        // 1、生成 Controller
        // 指定生成路径
        inputPath = projectPath + File.separator + "src/main/resources/templates/Controller.java.ftl";
        ...
        // 2、生成 Service 接口和实现类
        // 生成 Service 接口
        inputPath = projectPath + File.separator + "src/main/resources/templates/Service.java.ftl";
        ...
        // 生成 Service 实现类
        inputPath = projectPath + File.separator + "src/main/resources/templates/ServiceImpl.java.ftl";
        ...
        // 生成 DTO
        inputPath = projectPath + File.separator + "src/main/resources/templates/model/AddRequest.java.ftl";
        outputPath = String.format("%s/generator/model/dto/%sAddRequest.java", projectPath, upperDataKey);
        doGenerate(inputPath, outputPath, dataModel);
        // 生成 QueryRequest
        inputPath = projectPath + File.separator + "src/main/resources/templates/model/QueryRequest.java.ftl";
        outputPath = String.format("%s/generator/model/dto/%sQueryRequest.java", projectPath, upperDataKey);
        doGenerate(inputPath, outputPath, dataModel);
        // 生成 EditRequest
        inputPath = projectPath + File.separator + "src/main/resources/templates/model/EditRequest.java.ftl";
        outputPath = String.format("%s/generator/model/dto/%sEditRequest.java", projectPath, upperDataKey);
        doGenerate(inputPath, outputPath, dataModel);
        // 生成 UpdateRequest
        inputPath = projectPath + File.separator + "src/main/resources/templates/model/UpdateRequest.java.ftl";
        ...
        // 生成 VO
        inputPath = projectPath + File.separator + "src/main/resources/templates/model/VO.java.ftl";
